...
const FloatingWhatsApp = () => {
  ...
  const handleClick = () => {
    const message = "Olá! Vi o site da TC Shine e gostaria de saber mais sobre os serviços de limpeza.";
    ...
    <>
      ...
      {showTooltip && (
        <div className="fixed bottom-24 right-6 z-40 animate-fade-in">
          <div className="bg-white text-primary p-4 rounded-2xl shadow-lg border border-secondary/20 max-w-xs">
            <div className="flex items-start gap-3">
              <div className="text-2xl">👋</div>
              <div>
                <div className="font-montserrat font-bold text-sm mb-1">
                  Olá! Precisa de limpeza?
                </div>
